...
A collection of related music genre classification projects for reference and comparison.

## Projects

### 1. MusicGenreClassification
- **URL**: https://github.com/mlachmish/MusicGenreClassification
- **Date Added**: 2025-11-26
- **Notes**: To review and compare approaches

### 2. DeepAudioClassification
- **URL**: https://github.com/despoisj/DeepAudioClassification
- **Date Added**: 2025-11-26
- **Notes**: Deep learning approach for audio classification

---

## Comparison Notes

### Our Project (Music_ReClass) Unique Features:
- Progressive voting system (FMA + MERT + JMLA)
- Smart early stopping (20-40s avg processing)
- Optimized for NVIDIA Jetson ARM64
- Multiple training approaches (2 min to 12 hrs)
- Up to 94% accuracy with ensemble

### Areas to Research:
- [ ] Compare feature extraction methods
- [ ] Review their model architectures
- [ ] Check dataset usage and preprocessing
- [ ] Analyze accuracy benchmarks
- [ ] Look for novel techniques to incorporate
